...
public class TelaArtistaDetalhada extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        listaDeMusicas = findViewById(R.id.listasDeMusicas);
        setTitle("Força Suprema");
        capaArtista = findViewById(R.id.capa);
        nomeDoArtista = findViewById(R.id.artistName);
        descrisaoArtista = findViewById(R.id.artistDescription);

        Bundle musicData = getIntent().getExtras();
        if (musicData != null){
            capaArtista.setImageResource(musicData.getInt(PopularTrackConstants.TRACK_COVER));
            setTitle(musicData.getString(PopularTrackConstants.ARTIST_TITLE));
            nomeDoArtista.setText(musicData.getString(PopularTrackConstants.ARTIST_TITLE));
            descrisaoArtista.setText(musicData.getString(PopularTrackConstants.ARTIST_DESCRIPTION));
        }
